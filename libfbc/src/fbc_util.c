...
typedef struct particle { double pos, vel, best; } particle_t;
...
void fbcPIDAutotuneSimple(fbc_t* fbc, int timeout, int goal, FILE* lcd, double kP_min, double kP_max, double kI_min,
	...
	fbcPIDAutotuneFull(fbc, DEFAULT_NUM_ITERATIONS, DEFAULT_NUM_PARTICLES, timeout, goal, -goal, lcd, kP_min, kP_max,
	                   kI_min, kI_max, kD_min, kD_max, DEFAULT_K_SETTLE, DEFAULT_K_ITAE);
}
